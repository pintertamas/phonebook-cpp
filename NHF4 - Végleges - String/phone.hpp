...
public:
     ...
     */
    explicit Work(const std::string &number = "unknown", const std::string &name = "unknown", const std::string &email = "unknown",
...
public:
    ...
    explicit Private(const std::string &number = "unknown", const std::string &name = "unknown",
                     const std::string &nickname = "unknown", const std::string &email = "unknown",
                     const std::string &address = "unknown",
